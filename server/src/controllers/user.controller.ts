...
export const updateProfile = asyncHandler(async (req: AuthRequest, res: Response) => {
  const { name, mobile, gender, dateOfBirth } = req.body as {
    name?: string; mobile?: string; gender?: string; dateOfBirth?: string;
  };
  ...
  if (gender) user.gender = gender as 'male' | 'female' | 'other';
...
export const updateEyePower = asyncHandler(async (req: AuthRequest, res: Response) => {
  const { left, right } = req.body as { left: object; right: object };
...
export const addAddress = asyncHandler(async (req: AuthRequest, res: Response) => {
  ...
  const addressData = req.body as { isDefault?: boolean };
...
export const updateAddress = asyncHandler(async (req: AuthRequest, res: Response) => {
  ...
  const updates = req.body as Partial<typeof addr>;
...
export const createUser = asyncHandler(async (req: AuthRequest, res: Response) => {
  const { name, email, password, role, isEmailVerified } = req.body as any;
