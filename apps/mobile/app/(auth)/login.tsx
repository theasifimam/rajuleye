      ...
      >
        ...
        >
          ...
          <View style={styles.heroTextContainer}>
            <Text style={styles.heroTitle}>Spectacles</Text>
            <Text style={styles.heroSubtitle}>Crafted for your vision.</Text>
          </View>
        </ImageBackground>
        ...
        <View style={styles.formCard}>
          ...
          <Text style={styles.formSub}>Discover our latest collections.</Text>
          ...
          <View style={styles.inputGroup}>
            ...
            <View style={styles.inputWrapper}>
              ...
              <TouchableOpacity style={styles.hiddenBtn}>
                <Ionicons name="eye-outline" size={18} color="#8D8D8D" />
              </TouchableOpacity>
            </View>
          </View>
