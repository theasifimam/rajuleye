    ...
    <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="space-y-2 group">
          <label className="text-[10px] font-black uppercase tracking-widest text-muted-foreground/60 ml-4">
            Secure Mobile Number (10 digits)
          </label>
          <div className="relative">
            <span className="absolute left-6 top-1/2 -translate-y-1/2 text-sm font-bold text-muted-foreground">+91</span>
            <Input
              type="text"
              placeholder="1234567890"
              className="h-16 pl-16 pr-6 rounded-[1.25rem] bg-muted/30 border-none focus-visible:ring-2 focus-visible:ring-primary/20 font-bold transition-all"
        ...
        <Button
          type="submit"
          className="w-full h-18 rounded-[1.5rem] font-black text-xs uppercase tracking-[0.3em] shadow-2xl shadow-primary/20 group relative overflow-hidden mt-4"
          disabled={isLoading}
        >
          {isLoading ? (
      ...
      <div className="pt-6 text-center">
        <p className="text-[9px] font-bold text-muted-foreground/40 uppercase tracking-[0.2em] max-w-[280px] mx-auto leading-relaxed">
          By accessing this command center, you adhere to the Rajul Eye
