      ...
      <div className="hidden md:flex relative w-1/2 lg:w-[60%] bg-[#050505] p-12 lg:p-20 flex-col justify-between overflow-hidden group">
        ...
        <div className="relative z-10">
          ...
          <motion.div
            ...
            className="mt-12 inline-flex items-center gap-4 py-3 px-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md"
          >
            <div className="flex -space-x-2">
              {[1, 2, 3].map((i) => (
                <div key={i} className="h-8 w-8 rounded-full border-2 border-[#050505] bg-muted/20" />
              ))}
            </div>
      ...
      <div className="flex-1 flex flex-col justify-center items-center p-6 lg:p-12 relative bg-background">
        ...
        <div className="w-full max-w-[420px] relative z-10">
          ...
          <motion.div
            ...
            className="bg-card/20 md:bg-transparent backdrop-blur-3xl md:backdrop-blur-0 border border-white/10 md:border-none p-8 md:p-0 rounded-[2.5rem] md:rounded-none"
          >
            {children}
          </motion.div>
