...
const CategoryDialog = dynamic(
  () =>
    import("@/components/admin/CategoryDialog").then(
      (mod) => mod.CategoryDialog,
    ),
  { ssr: false },
);
import {
...
export default function CategoriesPage() {
  ...
  if (isError) {
    return (
      <div className="flex h-100 flex-col items-center justify-center gap-4 text-destructive">
    ...
    <div className="space-y-8 md:space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700 outline-none">
        ...
        <div className="relative z-10 flex flex-col xl:flex-row xl:items-center justify-between gap-8">
          <div>
            ...
            <p className="text-muted-foreground font-bold uppercase tracking-[0.2e] text-[9px] md:text-[10px] max-w-md leading-relaxed">
              Defining the architectural hierarchy of elegance. Structured
              collections that curate the global Rajul Eye experience.
            </p>
          </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 px-4 md:px-0">
        {[
          ...
          {
            label: "Deepest Hierarchy",
            value: "4 Levels",
            icon: ArrowUpDown,
            color: "blue",
          },
          {
            label: "Hidden Blueprints",
            value: "2 Hidden",
            icon: XCircle,
            color: "destructive",
          },
