...
const supportCategories = [
  {
    icon: BookOpen,
    title: "Documentation",
    description: "Guides on how to manage your store, products, and settings.",
    action: "View Docs",
    color: "text-blue-500",
    bg: "bg-blue-500/10",
  },
  {
    ...
    description: "Contact us for technical help with your store.",
    action: "Open Ticket",
    color: "text-primary",
    bg: "bg-primary/10",
  },
  {
    ...
    description: "Check security logs and manage your account security.",
    action: "Audit Logs",
  ...
  },
  {
    icon: Zap,
    title: "System Status",
    description: "Check if the system is running smoothly.",
    action: "Check Status",
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto space-y-12">
      ...
      <div className="relative group">
        <div className="absolute -inset-4 bg-linear-to-r from-primary/10 via-transparent to-transparent blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {supportCategories.map((category, index) => (
          <motion.div
            ...
            className="group relative bg-card/40 backdrop-blur-xl border border-border/50 rounded-[2rem] p-8 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/5 flex flex-col"
          >
            <div
              className={cn(
                "h-14 w-14 rounded-2xl flex items-center justify-center mb-6 transition-transform duration-500 group-hover:scale-110 group-hover:rotate-3",
                category.bg,
              )}
            >
              <category.icon className={cn("h-7 w-7", category.color)} />
            </div>
            <h3 className="text-lg font-black uppercase tracking-tight mb-2 italic">
              {category.title}
            </h3>
            ...
            <Button
              variant="ghost"
              className="w-full justify-between rounded-xl font-black uppercase tracking-widest text-[10px] group/btn hover:bg-primary hover:text-white transition-all duration-500"
            >
              {category.action}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-12">
        <div className="lg:col-span-2 bg-linear-to-br from-primary/5 to-transparent rounded-[2.5rem] border border-primary/10 p-10 relative overflow-hidden group">
          ...
          <div className="relative z-10">
            ...
            <p className="text-muted-foreground text-sm font-medium leading-loose max-w-lg mb-8 uppercase tracking-wide">
              If you have a critical problem or security concern, we are here to
              help 24/7.
            </p>
            <div className="flex flex-wrap gap-4">
              ...
              <Button
                variant="outline"
                className="rounded-2xl px-8 h-12 font-black uppercase tracking-[0.2em] text-xs border-primary/20 hover:bg-primary/5"
              >
                User Guide
              </Button>
            </div>
        ...
        <div className="bg-card/40 backdrop-blur-xl border border-border/50 rounded-[2.5rem] p-10 flex flex-col justify-center text-center group">
          ...
          <h2 className="text-xl font-black uppercase italic tracking-tight mb-4 text-primary">
            Safe & Secure
          </h2>
