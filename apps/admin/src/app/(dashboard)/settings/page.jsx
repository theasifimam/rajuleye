  ...
  return (
    <form onSubmit={onSubmit} className="space-y-8 md:space-y-12 pb-10">
      ...
      <Tabs defaultValue="website" className="px-4 md:px-0">
        <TabsList className="grid w-full h-14 grid-cols-2 max-w-xl mx-auto mb-8 md:mb-12 rounded-full bg-card border shadow-sm p-1">
          <TabsTrigger
            value="website"
            className="rounded-full font-black uppercase tracking-[0.2em] text-[10px] md:text-[11px] data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-lg data-[state=active]:shadow-primary/20 transition-all duration-500"
          >
            Website Setup
          </TabsTrigger>
          <TabsTrigger
        ...
        <TabsContent
          value="website"
          className="space-y-8 md:space-y-12 animate-in fade-in slide-in-from-left-8 duration-700 outline-none"
        >
                  ...
                  <label className="flex flex-col items-center justify-center w-full h-32 md:h-40 border-2 border-dashed border-primary/20 rounded-[2rem] cursor-pointer bg-muted/10 hover:bg-muted/30 hover:border-primary/50 transition-all overflow-hidden relative">
                    {logoUrl ? (
                      ...
                      <div className="flex flex-col items-center justify-center pt-5 pb-6 text-muted-foreground group-hover:text-primary transition-colors">
                        ...
                        <p className="text-sm font-bold mb-1">Upload Logo</p>
                      </div>
                    )}
                    <input
                      type="file"
        ...
        <TabsContent
          value="business"
          className="space-y-8 md:space-y-12 animate-in fade-in slide-in-from-right-8 duration-700 outline-none"
        >
          <div className="p-6 md:p-10 rounded-[2rem] md:rounded-[3.5rem] bg-card border shadow-sm border-primary/5 space-y-8 md:space-y-10 group/section max-w-4xl">
            <div className="flex items-center gap-4 md:gap-5">
              <div className="h-12 w-12 md:h-14 md:w-14 rounded-xl md:rounded-2xl bg-primary/10 text-primary flex items-center justify-center border border-primary/20 shadow-inner group-hover/section:scale-110 transition-transform">
