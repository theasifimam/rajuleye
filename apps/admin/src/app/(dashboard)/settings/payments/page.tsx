    ...
    return (
        <div className="space-y-8 md:space-y-12 pb-10">
            <PageHeader
                ...
                badgeText="Fiscal Matrix"
                titleMain="Payment"
                titleAccent="Engines"
                description="Orchestrating the flow of value. Managed encrypted gateways and fiscal liquidation protocols."
                actionIcon={Zap}
                actionLabel="Sync Gateways"
                onAction={() => console.log('Syncing gateways...')}
            />
