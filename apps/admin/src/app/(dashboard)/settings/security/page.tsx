...
export default function SecurityPage() {
    return (
        <div className="space-y-8 md:space-y-12 pb-10">
            <PageHeader
                badgeIcon={Shield}
                badgeText="Security Citadel"
                titleMain="Security"
                titleAccent="Fortress"
                description="Hardening the digital perimeter. Managed encrypted protocols and multi-factor authentication nodes."
                actionIcon={Key}
                actionLabel="Lockdown Parameters"
                onAction={() => console.log('Activating lockdown...')}
            />
