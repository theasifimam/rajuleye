    ...
    return (
        <div className="space-y-8 md:space-y-12 pb-10">
            <PageHeader
                ...
                description="Calibrating system notifications. Define the frequency and urgency of administrative telemetry."
                actionIcon={Zap}
                actionLabel="Sync Protocols"
                onAction={() => console.log('Syncing protocols...')}
            />
