                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-1 gap-3 md:gap-4 overflow-x-auto pb-4 lg:pb-0 scrollbar-none">
                        {[
                            ...
                            <button
                                key={i}
                                className={cn(
                                    "flex items-center gap-3 md:gap-4 p-4 md:p-5 rounded-[1.2rem] md:rounded-[1.5rem] transition-all duration-500 group relative overflow-hidden",
                                    item.active
                            ...
                            <div className="md:col-span-2 space-y-2 md:space-y-3">
                                ...
                                <div className="relative group/input">
                                    ...
                                    <textarea
                                        ...
                                        defaultValue="Bespoke high-end eyewear and precision lens technology. Curating the world's most exclusive optical heritage with uncompromising craftsmanship."
                                    />
                                </div>
                            </div>
                        </div>
