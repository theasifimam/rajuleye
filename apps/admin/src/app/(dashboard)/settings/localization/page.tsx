...
export default function LocalizationPage() {
    return (
        <div className="space-y-8 md:space-y-12 pb-10">
            <PageHeader
                badgeIcon={Globe}
                badgeText="Universal Grid"
                titleMain="Global"
                titleAccent="Localization"
                description="Calibrating the global reach of Rajul Eye. Managed regional parameters, linguistics, and fiscal denominations."
                actionIcon={Zap}
                actionLabel="Deploy Globally"
                onAction={() => console.log('Deploying globally...')}
            />
