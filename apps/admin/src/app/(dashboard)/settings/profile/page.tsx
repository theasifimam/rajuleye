...
import { Store, Save, Cpu, Smartphone } from 'lucide-react';
...
export default function ProfilePage() {
    return (
        <div className="space-y-8 md:space-y-12 pb-10">
            <PageHeader
                badgeIcon={Store}
                badgeText="Boutique Identity"
                titleMain="Boutique"
                titleAccent="Profile"
                description="Defining the global signature of Rajul Eye. Manage your boutique's nomenclature and visionary footprint."
                actionIcon={Save}
                actionLabel="Save Profile"
                onAction={() => console.log('Saving profile...')}
            />
                ...
                <div className="p-6 md:p-10 rounded-[2rem] md:rounded-[3.5rem] bg-card border shadow-sm border-primary/5 space-y-8 md:space-y-10 group/section">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 pt-2 md:pt-4">
                        ...
                        <div className="md:col-span-2 space-y-2 md:space-y-3">
                            ...
                            <textarea
                                className="w-full h-32 md:h-40 p-6 md:p-10 rounded-[1.5rem] md:rounded-[2.5rem] bg-muted/20 border-none font-black italic tracking-tight text-sm md:text-base shadow-sm outline-none resize-none leading-relaxed"
                                defaultValue="Bespoke high-end eyewear and precision lens technology. Curating the world's most exclusive optical heritage."
                            />
                        </div>
                    </div>
                </div>
