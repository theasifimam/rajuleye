...
import { Order, useUpdateOrderStatusMutation } from '@/store/orderApi';
                            ...
                            <div className="bg-primary/5 p-4 rounded-2xl border border-primary/20">
                                ...
                                <div className="flex flex-col gap-3">
                                    ...
                                    <Button
                                        ...
                                        disabled={isLoading || selectedStatus === order.orderStatus}
                    ...
                    <div className="bg-muted/10 rounded-2xl border border-primary/5 overflow-hidden">
                        ...
                        <div className="p-4 space-y-3">
                            {order.items.map((item, idx) => (
                                <div key={idx} className="flex items-center gap-4 bg-background p-3 rounded-xl border border-primary/5">
                                    <div className="h-12 w-12 rounded-lg bg-muted flex items-center justify-center overflow-hidden">
                                        {item.image ? (
                                            <img src={item.image} alt={item.name} className="w-full h-full object-cover" />
                                        ) : (
                                            <Box className="w-6 h-6 text-muted-foreground opacity-50" />
                                        )}
                                    </div>
