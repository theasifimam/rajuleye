    ...
    return (
        <>
            ...
            <motion.div
                ...
                className="hidden md:flex h-screen bg-card/80 backdrop-blur-xl border-r flex flex-col sticky top-0 z-[50] relative group/sidebar"
            >
                ...
                <button
                    ...
                    className={cn(
                        ...
                        isSidebarCollapsed ? "opacity-100" : "opacity-0 group-hover/sidebar:opacity-100"
                    )}
                >
                        ...
                        return (
                            <div key={item.label} className="space-y-1">
                                <Link
                                    ...
                                    className={cn(
                                        "group flex items-center py-2 px-4 rounded-[1.25rem] transition-all duration-500 relative overflow-hidden",
                                        isActive
                                ...
                                >
                                    ...
                                    <div className={cn("flex items-center justify-center gap-4 relative z-10 w-full", isSidebarCollapsed && "gap-0")}>
                                        <div className={cn(
                                            ...
                                            isActive ? "bg-white/20" : "bg-muted group-hover:bg-primary/5 group-hover:text-primary"
                                        )}>
                                    ...
                                    {!isSidebarCollapsed && isActive && !hasSubItems && (
                                        <motion.div
                                            ...
                                            className="absolute right-4 h-1.5 w-1.5 rounded-full bg-white shadow-[0_0_10px_white]"
                                        />
                                    )}
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            <div className={cn(
                                                                ...
                                                                isSubActive ? "bg-primary scale-125 shadow-[0_0_8px_rgba(34,197,94,0.5)]" : "bg-muted-foreground/30"
                                                            )} />
                                                            {subItem.label}
                                                        </Link>
                                                    );
                ...
                <div className="p-6 mt-auto relative z-10">
                    ...
                    >
                        ...
                        <div className={cn("flex items-center gap-4 relative z-10 w-full", isSidebarCollapsed && "gap-0")}>
                            <div className={cn(
                                "p-2 rounded-xl transition-all duration-500",
                                pathname === '/support' ? "bg-white/20" : "bg-muted group-hover:bg-primary/5 group-hover:text-primary"
                            )}>
                    ...
                    return (
                        ...
                        >
                            <div className={cn(
                                ...
                                isActive ? "bg-primary/20 scale-110 shadow-lg shadow-primary/10" : "hover:bg-muted"
                            )}>
                            ...
                            {isActive && (
                                <motion.div
                                    ...
                                    className="absolute -top-1 left-1/2 -translate-x-1/2 h-1 w-4 bg-primary rounded-full shadow-[0_0_10px_rgba(34,197,94,0.5)]"
                                />
                            )}
                        </Link>
                    );
