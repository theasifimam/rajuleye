...
export function Pagination({ currentPage, totalPages, onPageChange }: PaginationProps) {
    ...
    return (
        <div className="flex items-center gap-1 md:gap-2 rounded-3xl">
            <Button
                variant="outline"
                size="sm"
                disabled={currentPage === 1}
                onClick={() => onPageChange(currentPage - 1)}
                className="h-10 rounded-3xl border-2"
            >
                <ChevronLeft />
            </Button>
            ...
            {pages[0] > 1 && (
                <>
                    <Button
                        ...
                        className="h-10 w-10 md:h-11 md:w-11 rounded-3xl font-black uppercase tracking-widest text-[9px] md:text-[10px] border-2 hover:border-primary transition-colors"
                    >
                        1
                    </Button>
            ...
            {pages.map(page => (
                <Button
                    ...
                    className={`h-10 w-10 md:h-11 md:w-11 rounded-3xl font-black uppercase tracking-widest text-[9px] md:text-[10px] ${currentPage === page
