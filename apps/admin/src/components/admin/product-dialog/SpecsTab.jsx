...
export function SpecsTab({ control }) {
    return (<div className="space-y-5 animate-in fade-in slide-in-from-left-4 duration-500">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <FormField control={control} name="frameColor" render={({ field }) => (<FormItem className="space-y-3">
