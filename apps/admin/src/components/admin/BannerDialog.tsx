...
import { BannerFormSchema, type BannerFormValues } from '@/lib/zod-schemas';
import { useCreateBannerMutation, useUpdateBannerMutation, type Banner } from '@/store/bannerApi';
...
export function BannerDialog({ isOpen, onOpenChange, banner }: BannerDialogProps) {
    ...
    const onSubmit = async (values: BannerFormValues) => {
        try {
            ...
            toast.error((error as any)?.data?.message || 'Failed to save campaign');
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div
                                        ...
                                        className="relative h-64 rounded-2xl border-2 border-dashed border-primary/20 bg-muted/30 hover:bg-primary/5 hover:border-primary/40 transition-all duration-300 flex flex-col items-center justify-center cursor-pointer overflow-hidden group"
                                    >
                                        {imagePreview ? (
                                            <>
                        ...
                        <div className="p-6 md:p-8 border-t border-primary/5 bg-primary/[0.01] flex items-center justify-between">
                            ...
                            >
                                {loading ? (
                                    ...
                                    <span className="text-[10px] font-black uppercase tracking-[0.2em]">Save Campaign</span>
                                )}
                            </Button>
                        </div>
                    </form>
