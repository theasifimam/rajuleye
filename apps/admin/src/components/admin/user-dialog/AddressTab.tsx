...
export function AddressTab({ control }: AddressTabProps) {
        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="flex items-center justify-between">
                ...
                <Button
                    ...
                    variant="outline"
                    size="sm"
                    onClick={() => append({ label: 'Home', fullName: '', line1: '', city: '', state: '', pincode: '', country: 'India', mobile: '', isDefault: fields.length === 0 })}
                    className="rounded-xl border-primary/20 text-primary hover:bg-primary/5 font-black text-[9px] uppercase tracking-widest h-9 border-2"
                >
            ...
            <div className="space-y-6">
                {fields.length === 0 && (
                    <div className="p-12 border-2 border-dashed border-primary/10 rounded-[2rem] flex flex-col items-center justify-center text-center">
                ...
                {fields.map((field, index) => (
                    <div key={field.id} className="relative p-6 md:p-8 rounded-[2rem] border-2 border-primary/5 bg-primary/[0.01] hover:border-primary/20 transition-all group/address">
