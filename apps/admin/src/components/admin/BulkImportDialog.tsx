...
export function BulkImportDialog({ isOpen, onOpenChange }: BulkImportDialogProps) {
    ...
    const handleImport = async () => {
        ...
        try {
            ...
            toast.error((err as { data?: { message?: string } })?.data?.message || 'Import failed');
        }
    };
    ...
    const handleUploadImages = async () => {
        ...
        try {
            ...
            toast.error((err as { data?: { message?: string } })?.data?.message || 'Upload failed');
        }
    };
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-6 p-6 rounded-[2rem] bg-muted/20 border border-primary/5">
                            ...
                            <div
                                ...
                                className="cursor-pointer group flex flex-col items-center justify-center gap-3 p-8 border-2 border-dashed border-primary/10 rounded-2xl hover:border-primary/30 hover:bg-primary/[0.02] transition-all"
                            >
                        ...
                        <div className="space-y-6 p-6 rounded-[2rem] bg-muted/20 border border-primary/5">
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <Button
                                    variant="link"
                                    className="p-0 h-auto w-fit text-primary font-black uppercase text-[9px] tracking-widest"
                    ...
                    {results && (
                        <div className="mt-8 space-y-4 animate-in slide-in-from-bottom-4 duration-500">
                            ...
                            {results.errors.length > 0 && (
                                <div className="p-6 rounded-[1.5rem] bg-destructive/5 border border-destructive/10">
                                    ...
                                    <div className="space-y-2 max-h-40 overflow-y-auto pr-2">
                                        {results.errors.map((err, idx: number) => (
                                            <div key={idx} className="flex items-center justify-between text-[10px] font-bold border-b border-destructive/5 pb-2">
