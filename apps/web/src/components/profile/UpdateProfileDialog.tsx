...
interface UpdateProfileDialogProps {
    ...
    onOpenDeletion?: (step: 'warn' | 'otp') => void;
}

export function UpdateProfileDialog({ isOpen, onOpenChange, onOpenDeletion }: UpdateProfileDialogProps) {
    ...
    return (
        ...
        >
            <div className="flex flex-col items-center mb-8 pt-4">
                ...
                <button
                    onClick={() => fileInputRef.current?.click()}
                    className="text-[10px] font-black uppercase tracking-widest text-primary mt-4 hover:underline"
                >
            ...
            <form onSubmit={handleUpdate} className="space-y-6">
                ...
                <div className="space-y-2 group opacity-60">
                    ...
                    <div className="relative">
                        ...
                        <Input
                            ...
                            disabled
                            className="h-14 pl-12 rounded-2xl bg-muted border-none font-bold cursor-not-allowed"
                        />
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2 group">
                        ...
                        <select
                            ...
                            className="w-full h-14 px-4 rounded-2xl bg-muted/30 border-none focus:ring-2 focus:ring-primary/20 font-bold text-sm outline-none appearance-none"
                        >
                ...
                <Button
                    type="submit"
                    className="w-full h-16 rounded-full font-black text-xs uppercase tracking-[0.2em] shadow-xl mt-4 group overflow-hidden relative"
                    disabled={isUpdating}
                >
                    {isUpdating ? (
            ...
            <div className="mt-12 pt-8 border-t border-destructive/10">
                <div className="bg-destructive/5 rounded-3xl p-6 border border-destructive/10">
                    ...
                    <Button
                        ...
                        className="w-full h-12 rounded-xl border border-destructive/20 text-destructive hover:bg-destructive hover:text-white font-bold text-xs uppercase tracking-widest transition-all"
                    >
