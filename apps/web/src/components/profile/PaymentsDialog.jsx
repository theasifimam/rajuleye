...
export function PaymentsDialog({ isOpen, onOpenChange }) {
    return (<ResponsiveModal isOpen={isOpen} onOpenChange={onOpenChange} title="Payment Methods" className="sm:max-w-[550px]">
            <div className="space-y-6">
                ...
                <div className="pt-4">
                    <Button className="w-full h-16 rounded-2xl font-black text-sm uppercase tracking-widest shadow-lg border-2 border-primary bg-transparent text-primary hover:bg-primary hover:text-white transition-all flex items-center justify-center gap-2">
