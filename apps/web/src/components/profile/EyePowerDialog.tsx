...
interface EyePowerDialogProps {
    isOpen: boolean;
    onOpenChange: (open: boolean) => void;
}

export function EyePowerDialog({ isOpen, onOpenChange }: EyePowerDialogProps) {
    ...
    const renderEyeFields = (side: 'left' | 'right') => (
        <div className="space-y-4 p-6 rounded-3xl bg-muted/20 border border-border/50">
