...
export function ProductImageCarousel({ images, name }: ProductImageCarouselProps) {
    ...
    return (
        <div className="relative w-full group">
                    ...
                    {displayImages.map((image, index) => (
                        <button
                            ...
                            className={cn(
                                ...
                                current === index ? "border-primary shadow-md" : "border-transparent grayscale opacity-60 hover:opacity-100 hover:grayscale-0"
                            )}
                        >
                            <Image
                                src={image}
            ...
            {displayImages.length > 1 && (
                <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex gap-1.5 px-3 py-1.5 rounded-full bg-black/20 backdrop-blur-sm pointer-events-none sm:hidden">
