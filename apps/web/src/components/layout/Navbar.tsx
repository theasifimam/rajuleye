...
import { ShoppingBag, Search, Menu, User, ShoppingCart, X, Eye, Heart } from 'lucide-react';
...
import { Home, Settings, Package, ChevronRight, LogIn } from 'lucide-react';
    ...
    return (
        <header className="fixed top-0 left-0 right-0 z-[100] pointer-events-none lg:px-6">
            ...
            <div className={cn(
                ...
                scrolled && "lg:h-16 lg:mt-2 lg:bg-background/80 lg:backdrop-blur-2xl lg:border lg:border-white/20 lg:dark:border-white/10 lg:rounded-full lg:shadow-[0_8px_32px_rgba(0,0,0,0.1)] lg:px-6",
                scrolled && "bg-background/95 backdrop-blur-md border-b border-border/10 lg:border-b-0 h-16"
            )}>
                ...
                <Link href="/" className="absolute left-1/2 -translate-x-1/2 hidden lg:flex items-center gap-3 group focus:outline-none pointer-events-auto">
                    <div className="flex items-baseline gap-1.5 select-none transition-all duration-500 group-hover:tracking-normal">
                        ...
                        <span className={cn(
                            ...
                            scrolled ? "text-foreground/50 group-hover:text-foreground/80" : "text-white/50 group-hover:text-white/80"
                        )}>
                            Eye
                        </span>
                    </div>
