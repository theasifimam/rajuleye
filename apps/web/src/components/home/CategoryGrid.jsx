        ...
        {cat1 && (
          ...
          >
            <Image
              src={
                cat1.image ||
                "https://images.unsplash.com/photo-1559166588-4a3e0c7a2094?w=800&q=80"
              }
              alt={cat1.name}
              fill
        ...
        {cat3 && (
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center p-6 bg-black/10">
              <h3 className="text-lg md:text-xl font-black text-white uppercase text-center tracking-tighter leading-none">
                {cat3.name}
              </h3>
            </div>
          </Link>
