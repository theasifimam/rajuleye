                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
                    ...
                    <div className="lg:col-span-3 space-y-12">
                        <div className="sticky top-32 space-y-8">
                            ...
                            <nav className="flex flex-col gap-6">
                                {['Condition of Sale', 'Privacy Directive', 'Optic Warranty', 'Digital Conduct'].map((item) => (
                                    <button key={item} className="text-sm font-black text-muted-foreground hover:text-primary transition-colors uppercase tracking-tight text-left">
                                        {item}
                                    </button>
                                ))}
                            </nav>
                    ...
                    <div className="lg:col-span-9 space-y-32">
                        {[
                            ...
                            <div key={idx} className="space-y-12 max-w-3xl group">
