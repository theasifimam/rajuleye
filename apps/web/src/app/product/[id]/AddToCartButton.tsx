...
export function AddToCartButton({ product, compact = false }: { product: Product; compact?: boolean }) {
    ...
    return (
        <div className={cn("flex flex-col gap-6 w-full", compact ? "max-w-none" : "max-w-md")}>
            {!compact && (
            ...
            <div className="flex flex-row gap-3 w-full">
                ...
                <Button
                    ...
                    size="lg"
                    className={cn(
                        "flex-[1.5] rounded-full text-[10px] sm:text-xs font-black uppercase tracking-[0.1em] sm:tracking-[0.2em] transition-all duration-500 relative overflow-hidden bg-primary text-primary-foreground hover:scale-[1.02] shadow-xl shadow-primary/20",
                        compact ? "h-12" : "h-16",
