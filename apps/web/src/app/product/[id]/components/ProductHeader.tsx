...
export function ProductHeader({
    ...
    return (
        <>
            ...
            <header
                className={cn(
                    "fixed top-4 left-4 right-4 z-[100] transition-all duration-500 md:hidden",
                    scrolled ? "translate-y-0 opacity-100" : "translate-y-0"
                )}
            >
                <div className={cn(
                    "flex items-center justify-between h-14 px-4 rounded-2xl border transition-all duration-500",
                    scrolled
                ...
                <div className="flex items-center gap-6">
                    ...
                    <div className="flex items-center gap-3">
                        <Button
                            ...
                            size="icon"
                            className={cn(
                                "rounded-full h-11 w-11 border border-border hover:border-rose-300 hover:bg-rose-50 transition-all",
                                isWishlisted && "bg-rose-50 text-rose-500 border-rose-200 fill-rose-500"
                            )}
                            onClick={() => {
                                if (isWishlisted) {
                                    setShowConfirm(true);
