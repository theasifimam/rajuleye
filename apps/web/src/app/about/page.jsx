...
export default function AboutPage() {
    return (<div className="flex flex-col gap-24 py-24">
            ...
            <section className="container px-6 md:px-12 mx-auto max-w-[1600px]">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    <div className="aspect-[4/5] lg:aspect-square xl:aspect-[4/5] relative rounded-[3rem] overflow-hidden bg-muted animate-in fade-in slide-in-from-right duration-1000 shadow-2xl">
                        <Image src="https://images.unsplash.com/photo-1641048927024-0e801784b4f7?q=80&w=1000&auto=format&fit=crop" alt="Precision Eyewear Architecture" fill className="object-cover transition-transform duration-700 hover:scale-105"/>
        ...
        ].map((item, i) => (<div key={i} className="p-12 bg-background rounded-[2.5rem] border border-border/50 hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 group">
