...
export default function HelpPage() {
    return (<div className="flex flex-col gap-24 py-24">
        ...
        ].map((item, i) => (<div key={i} className="p-6 xs:p-8 md:p-10 bg-card rounded-[2rem] md:rounded-[2.5rem] border border-border/50 hover:bg-primary/5 transition-all duration-500 cursor-pointer group text-center flex flex-col items-center">
